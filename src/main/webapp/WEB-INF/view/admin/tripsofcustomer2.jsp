...
<head>
  ...
  <meta name="author" content="" />
    ...
    <title>Urotaxi</title><base href="${pageContext.request.contextPath}/"><base href="${pageContext.request.contextPath}/">
    ...
    <h1 class="fa fa-align-center text-center" aria-hidden="true">List Of Customers</h1> 
        <table class="table table-striped text-center " align="center">
            ...
            for(Customer customer : list)
            {
                ...
                out.println("<td><a href=\"/admin/gettripscustomer?customerid=" + customer.getCustomerId() + "\">"+"<b>View Trips</b>"+"</a></td>");
